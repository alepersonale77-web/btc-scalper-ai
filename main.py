...
# ============================================================
# BTC TREND AI v0.9.6 - DUAL: TREND / SWING + SCALP
# MODIFICA v0.9.6:
...
def build_telegram_message(
    ...
    if state == "ROSSO":
        return (
            "[NO TRADE - TREND] BTC Trend AI v0.9.6\n\n"
    ...
    if state == "GIALLO":
        return (
            "[PREALLERTA - TREND] BTC Trend AI v0.9.6\n\n"
    ...
    return (
        "[SETUP CONFERMATO - TREND] BTC Trend AI v0.9.6\n\n"
        f"{setup_label(state, score, quality)}\n"
        f"{authorization}\n\n"
        f"Broker operativo: {broker_name}\n"
        f"Capitale broker impostato: "
...
def build_scalp_green_message(
    ...
    return (
        f"[{direction} SCALP - INGRESSO] BTC Trend AI v0.9.6\n\n"
...
async def main() -> None:
    print(
        "BTC Trend AI v0.9.6 DUAL Trend+Scalp Multi-Broker avviato",
        flush=True,
    )
